 ...
 */
public class ElEmpleoHome implements Question<List<String>>{

	@Override
	public List<String> answeredBy(Actor actor) {
		return Text.of(ElEmpleoHomeComponents.HOME_TEXT).viewedBy(actor).asList();
		}

		public static Question<List<String>> isDisplayedAnd() {
			return new ElEmpleoHome();
		}
